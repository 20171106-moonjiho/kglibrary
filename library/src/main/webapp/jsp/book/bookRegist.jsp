	...
	<div align="center" style="margin-top: 50px; margin-bottom: 50px;">
		...
		<form action="bookRegistProc" method="post"	enctype="multipart/form-data" id="f">
			<table>
				...
				<tr align="center">
					<td colspan="2">
						<div class="card-write" align="center">
							...
							<input type="text" name="book_count" id="book_count" placeholder="책 갯수"><br><br>
				...
				<tr align="center">
					<td colspan="2"><textarea style="width: 100%; margin-left: 10px; resize: none;" rows="10" cols="30"
					name="detail_link"></textarea></td>
				</tr>
				<tr align="center">
				...
				<tr>
					...
					<td><input type="button" class="submit_button" value="도서 등록" onclick="bookCheck()">
						<input type="button" class="submit_button" value="취소" onclick="location.href='index'"><br>
					</td>
				</tr>
			</table>
		</form>
