	...
	<font color="red" >${msg }</font>
		<form action="joinProc" method="post" id="f">
			<table class="table_bwrite">
				...
				<tr>
					<th>상세주소</th>
					<td><input type="text" name="detailAddress" id="sample6_detailAddress"><br></td>
				</tr>
				<tr>
					<th>전화번호</th>
					<td><input type="text" name="tel" id="tel">
				        <input type="hidden" id="phoneAutChk"/>
				        <input  class="signin_pass" type="button" value="입력" id="phoneChk"><br>
				        <!-- phoneChk 클릭시 함수 발동 --></td>
				</tr>
				<tr>
					<th>인증번호</th>
				...
				<tr>
					<td colspan="2" class="content"><input type="button" value="회원가입" onclick="allCheck()">
