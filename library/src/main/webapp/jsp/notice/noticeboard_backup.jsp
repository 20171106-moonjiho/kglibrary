...
<div style="width: 1200px; margin: 0 auto; margin-top: 100px; margin-bottom: 50px;">
	...
	<table>
		...
		<c:forEach var="board" items="${boards }">
			...
			<tr>
				<td class="center"><a href="noticeboard_Content?no=${board.no }">${board.no }</a></td>
				<td class="left"><a href="noticeboard_Content?no=${board.no }">${board.title }</a></td>
	...
	<span class="right"><input type="button" value="글쓰기" onclick="location.href='noticeboard_write'"
		class="submit_button">
	</span>
</div>
