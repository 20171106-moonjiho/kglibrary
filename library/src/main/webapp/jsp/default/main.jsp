		...
		<div  class="content_box_1" style="width: 1200px; margin: 0 auto; margin-top: 35px;">
			...
			<tbody><tr>
				<td style="width:250px;" valign="top">
					<table cellspacing="0">
			<tbody><tr>
				<td style="padding:3px; border:1px solid #efefef;" bgcolor="#FFFFFF"><a href="animal_protect_Content2?no=${board.no }"><img src="../img/${board.image}" align="absmiddle" border="0" width="250" height="200" style="border-radius: 10px 10px;"></a></td>
			</tr></tbody></table></td></tr>
