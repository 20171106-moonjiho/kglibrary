	...
	<div align="center" style="margin-top: 50px; margin-bottom: 50px;">
		...
		<form action="bookHopeRegistProc" method="post" id="f">
			<table>
				...
				<tr>
					<td>
						<div class="card-write">
							<div class="title-w">
								<input type="text" name="board_title" placeholder="제목"	id="board_title">
							</div>
				...
				<tr>
					<td><textarea style="width: 100%; margin-left: 10px; resize: none;" rows="10" cols="100"
					name="reason"></textarea></td>
				</tr>
				<tr>
					<td><input type="button" class="submit_button" value="신청 등록" onclick="bookHopeCheck()">
					<input type="button" class="submit_button" value="취소" onclick="location.href='bookHopeForm'"><br></td>
				</tr>
			</table>
		</form>
	</div>
