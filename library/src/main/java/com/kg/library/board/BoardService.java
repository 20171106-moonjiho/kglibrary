...
public class BoardService {
	...
	public void getList(String pageNum, Model model) {
		...
		int pageBlock = 5; // 한 페이지에 출력할 게시글 수
 ...
 */
	...
	public String deleteProc(String num,String pass) {
		int n = 0;
		try {
		...
		BoardDTO board = mapper.pass(n);
		if(board.getPass().equals(pass) ==false) {
			return "비밀번호가 틀립니다.";
		}
	...
	public BoardDTO deleteForm(String num) {
		int n = 0;
		try {
			n = Integer.parseInt(num);
		} catch (Exception e) {
	...
	public int updateProc(BoardDTO board) {
